...
function updateTimers(){                                         
    ...
    document.getElementById("fastest").textContent = "Fastest: " + fastestTime.toFixed(1) + "s";
    document.getElementById("avgTime").textContent = "Avg Time: " + (totalTime / totalGames).toFixed(1) + "s";
}
